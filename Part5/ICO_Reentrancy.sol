...
// ***************************************************************************
// CAUTION : THIS CONTRACT IS SUSCEPTIBLE TO RE-ENTRENCY ATTACK - DO NOT USE !
// ***************************************************************************

import "./MyB2EToken.sol";

contract ICO_Reentrancy {
	...
	function ICO_Reentrancy(address _token_adress, uint _start, uint _end, uint _minimumEth, uint _price) public {
        owner = msg.sender;
	...
	// Called when someone sends Ether directly to the ICO contract's adress
	// Token owner must have approved the ICO to spend his tokens
